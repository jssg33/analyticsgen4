...
public static class ApplicationApiController
{
    ...
    {
        app.MapGet("/api/ApplicationApi", async (ApiDbContext db) =>
        {
        ...
        app.MapGet("/api/ApplicationApi/{id:int}", async (
            int id,
            ApiDbContext db) =>
        {
        ...
        app.MapGet("/api/ApplicationApi/Application/{applicationId:int}",
            async (int applicationId, ApiDbContext db) =>
        {
        ...
        app.MapGet("/api/ApplicationApi/ApiHost/{apiHostId:int}",
            async (int apiHostId, ApiDbContext db) =>
        {
            var items = await db.ApplicationApis
        ...
        app.MapPost("/api/ApplicationApi",
            async (ApplicationApi item, ApiDbContext db) =>
        {
