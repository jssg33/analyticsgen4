...
public static class ApplicationController
{
    ...
    {
        app.MapGet("/api/Application", async (ApiDbContext db) =>
        {
        ...
        app.MapGet("/api/Application/{id:int}", async (int id, ApiDbContext db) =>
        {
        ...
        app.MapPost("/api/Application", async (Application item, ApiDbContext db) =>
        {
        ...
        app.MapPut("/api/Application/{id:int}", async (
            int id,
            Application update,
            ApiDbContext db) =>
        {
        ...
        app.MapDelete("/api/Application/{id:int}", async (
            int id,
            ApiDbContext db) =>
        {
            var item = await db.Applications.FindAsync(id);
