...
(function () {
  ...
  window.Cocky = { CFG, SCHEMA, PAGES, api, layout, toast, errorBox, spinner, renderTable, filterRows, openRecordForm, confirmDelete, crudPage, esc, titleCase, fmtValue, parseDate, dateMs, ensureRefs, refText, isLiveException, hostException };
})();
